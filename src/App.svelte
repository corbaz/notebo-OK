<script lang="ts">
	...
	/* 	import MENU from "./components/00-Menu.svelte"; */
	import HEADER from "./components/01-Header.svelte";
	import MAIN from "./components/02-Main.svelte";
	import FOOTER from "./components/03-Footer.svelte";
	import CHAT from "./components/04-Chat.svelte";
		...
		<div
			...
			<div
				...
				<div class="flex justify-center">
					<button
						class="flex items-center px-4 py-2 mt-auto font-semibold text-white transition duration-500 ease-in-out transform rounded-lg shadow-xl bg-gradient-to-r from-blue-700 hover:from-blue-600 to-blue-600 hover:to-blue-700 focus:shadow-outline focus:outline-none">
						Action
					</button>
					<p
						class="mt-2 text-sm text-center text-gray-600 md:ml-6 md:mt-0 sm:text-left">
