...
<div class="mb-2">
            <span class="badge mb-1 font-ano">Default  Ano</span>

            <span class="badge badge-light mb-1 font-raj">Light Raj</span>

            <span class="badge badge-blue mb-1 font-giorgio">Blue Giorigio</span>
 
            <span class="badge badge-green mb-1 font-lato">Green Lato</span>

            <span class="badge badge-yellow mb-1 font-robot">Yellow Robot</span>

            <span class="badge badge-red mb-1 font-open">Red Open</span>
        </div><!--
...
<nav class="bg-gray">
  ...
  <div class="hidden sm:hidden">
    <div class="px-2 pt-2 pb-3">
      <a href="/" class="block px-3 py-2 rounded-md text-base font-medium text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Servicios</a>
      <a href="/" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Productos</a>
      <a href="/" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Prroyectos</a>
      <a href="/" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Blog</a>
    </div>
  </div>
</nav>
